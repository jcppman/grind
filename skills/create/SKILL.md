...
Read the [shared operating protocol](../../docs/protocol.md). Establish the intended
outcome and choose a name and the narrowest workspace-relative folder containing
...
request and keep the ledger resumable. Add specifications or plans only as needed.
